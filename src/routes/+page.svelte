...
<div class="flex flex-1 min-h-0 overflow-hidden">
 ...
 placeholder="Search..." class="input flex-1"/>
          ...
          <div class="flex-1 overflow-y-auto p-5 bg-gray-900/30">
            ...
            <div class="space-y-3">
              {#if filteredItems.length === 0}
               ...
               <div class="text-center py-8"><p class="text-gray-500">No items found</p><p class="text-sm text-gray-600 mt-2">{searchTerm ||
 selectedFilter !== 'all' ? 'Try a different search or filter' : 'Add an item to begin'}</p></div>
              {:else}
